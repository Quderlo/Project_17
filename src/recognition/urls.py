...
from .views import CameraListView, CameraAuthListView, CameraDetailView, CameraAuthDetailView, CameraCreateView, \
    CameraActiveListView, CameraInactiveListView

urlpatterns = [
    # Пути для камер
    path('camera-list/', CameraListView.as_view(), name='camera-list'),
    path('camera-active-list/', CameraActiveListView.as_view(), name='camera-active-list'),
    path('camera-inactive-list/', CameraInactiveListView.as_view(), name='camera-inactive-list'),
